...
public class SplitButtonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_split_button);
        ...
        documentationButton.setOnClickListener(v -> {
            WebViewBottomSheetFragment bottomSheet = WebViewBottomSheetFragment.newInstance(
                    "https://github.com/material-components/material-components-android/blob/master/docs/components/Button.md#split-button"
            );
